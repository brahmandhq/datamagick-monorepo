...
export default function Home({ tweets = [] }) {
  ...
  const learningToolsFeatures = [
    ...
    },
    {
      ...
      body: (
        <>
          Stay ahead of the curve by learning new technologies and advanced
          concepts from experts anywhere anytime
        </>
      ),
  ...
  const sections = [
    {
      name: "DataMagick",
      description: `The Essential AI Assistant for Developers. QueryDB uses natural language and AI to query databases in seconds. Cut SQL writing time by 90%. Unlock insights faster with auto-generated SQL. Intuitive plain English interface makes querying easy. The future of SQL is here with QueryDB's AI assistant`,
            ...
            <div className="col-span-12 py-12 pt-0 text-center">
              <div className="mx-auto mb-6 w-min">
                <a
                  ...
                  style={{
                    textDecoration: "none",
                    transition: "background 260ms ease 0s, width 0s ease 0s",
                    outline: "none",
                    animation:
      ...
      <section className="my-20 mb-40">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 xl:px-8">
          ...
          <div className="mt-8 flex justify-center space-x-3">
            <Link href={getStartedLink}>
              <Button className="nextui-blue-btn mx-auto" shadow size="lg">
                Get Started
              </Button>
            </Link>
          </div>
