...
const title = 'DataMagic';
const description = 'The Essential Database Tool';
const ogImageLink = 'https://datamagick.com/screenshots/og-image.png';
    ...
    render() {
        return (
          ...
          /> */}
                    ...
                    <meta name="application-name" content="DataMagic" />
                    ...
                    <meta
                        name="description"
                        content="The Essential Database Tool"
                    />
                    ...
                    <meta property="og:site_name" content="DataMagic" />
